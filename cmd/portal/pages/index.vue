            ...
            <div class="card floa">
              ...
              <div class="card-body">
                <div class="mb-3 text-left">
                  Centrally manage all aspects of the Hekate
                </div>
          ...
          <div class="col-sm-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="https://github.com/sh-miyoshi/hekate"
                  >Go to Hekate Project</a
                >
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    login() {
      this.$store.commit('setCurrentProject', this.$config.get().LOGIN_PROJECT)
      this.$auth.Login()
    }
  }
}
